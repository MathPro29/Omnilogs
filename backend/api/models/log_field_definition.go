...
type LogFieldDefinition struct {
	...
	ConfigJSON           *json.RawMessage `gorm:"type:jsonb;serializer:json" json:"config_json,omitempty"`
	IsFavorite           bool             `gorm:"not null;default:false;index" json:"is_favorite"`
	SampleValue          *json.RawMessage `gorm:"type:jsonb;serializer:json" json:"sample_value,omitempty"`
	DetectedType         *string          `json:"detected_type,omitempty"`
	SamplePathFound      bool             `gorm:"not null;default:true" json:"sample_path_found"`
	Timestamps
}
