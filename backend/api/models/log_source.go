...
type LogSource struct {
	...
	ProductID       *int       `gorm:"uniqueIndex:uq_log_source,priority:1;index:idx_source_type,priority:1;index:idx_source_platform,priority:1;index:idx_source_active,priority:1" json:"product_id,omitempty"`
	SourceCode      string     `gorm:"not null;uniqueIndex:uq_log_source,priority:2" json:"source_code"`
