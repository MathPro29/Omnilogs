...
func main() {
	...
	clearTable(&models.LogArchive{}, "log_archives")
	clearTable(&models.LogObjectStorageRef{}, "log_object_storage_refs")
	clearTable(&models.SystemAuditLog{}, "system_audit_logs")
